...
public class SyroleService extends CommonService<Syrole> {
	 ...
	 * @author devchao
	 */
	public List<Map<String,Object>> queryRoleListByUserId(String userId){
		String sql="select r.NAME rolename,r.DESCRIPTION roledesc from sys_user u,syuser_syrole ur," +
				"syrole r where u.id=ur.SYUSER_ID and ur.SYROLE_ID=r.ID and userId='"+userId+"'";
		logger.info("sql:"+sql);
