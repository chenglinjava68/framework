 ...
 * @version V1.0
 */
public class DynamicReportConstant {
	/** 抬头配置 */
	public static final String MAIN=  "headers";
	/** 明细配置*/
	public static final String ITEMS=  "config_fieldList";
	/**	配置的id*/
	...
	/** 抬头配置-查询SQL*/
	public static final String CONFIG_SQL=  "cgr_sql";
	/** 字典编码*/
	public static final String ITEM_DICCODE= "dict_code";
	/** 取值表达式*/
	public static final String ITEM_REPLACE = "replace_va";
	/** 明细配置-字段名*/
	public static final String ITEM_FIELDNAME =  "field_name";
	/** 明细配置-是否查询*/
	public static final String ITEM_ISQUERY =  "s_flag";
	/** 明细配置-字段类型*/
	public static final String ITEM_FIELDTYPE =  "field_type";
	/** 明细配置-字段默认值*/
	public static final String ITEM_DEFAULTVALUE =  "default_value";
	/** 明细配置-查询模式*/
	public static final String ITEM_QUERYMODE =  "s_mode";
	/**逻辑true*/
